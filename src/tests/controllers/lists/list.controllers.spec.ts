...
describe("ListController", () => {
  describe("createList", () => {
    it("should create a List in the db", async () => {
      const response = await chai.request(app).post("/api/v1/list").send(stubList);
  ...
  describe("getAllLists", () => {
    it("should get all Lists in the db", async () => {
      const response = await chai.request(app).get("/api/v1/lists");
  ...
  describe("getAList", () => {
    it("should get a single List in the db", async () => {
      const response = await chai.request(app).get("/api/v1/list/2");
  ...
  describe("updateList", () => {
    it("should update a single List in the db", async () => {
      const response = await chai.request(app).patch("/api/v1/list/3").send({
  ...
  describe("deleteList", () => {
    it("should delete a single List in the db", async () => {
      const response = await chai.request(app).delete("/api/v1/list/3");
    ...
    it("return error for not found list", async () => {
      const response = await chai.request(app).delete("/api/v1/list/30");
  ...
  describe("getAllItemsInList", () => {
    it("should get all items from a list", async () => {
      const response = await chai.request(app).get("/api/v1/list/1/items");
  ...
  describe("getAnItemInAList", () => {
    it("should get a single List in the db", async () => {
      const response = await chai.request(app).get("/api/v1/list/2/item/4");
